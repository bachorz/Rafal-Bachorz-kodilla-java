...
public class Options {
    ...
    public static final String  INGREDIENTS_MUSHROOMS = "Mushrooms";
    public static final String  INGREDIENTS_PEPPER = "Pepper";
    public static final String  INGREDIENTS_SALAMI = "Salami";
